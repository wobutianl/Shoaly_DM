...
#----------------------------------------------------------------------
#----------------------------------------------------------------------
def text_panel(p,  file_path = r'C:\Users\jerryfive\Desktop\main.txt'):
    """"""
    ...
    ed.SetText(open(file_path).read())
    ed.EmptyUndoBuffer()
    ed.Colourise(0, -1)
...
class StaticTextFrame(wx.Frame):  
    def __init__(self):  
        ...
        ed.SetText(demoText + open(r'C:\Users\jerryfive\Desktop\main.txt').read())
        ed.EmptyUndoBuffer()
        ed.Colourise(0, -1)
        
        file = r'C:\Users\jerryfive\Desktop\main.py'
        name = file.split("\\")[-1]
        print name
