...
class SketchFrame(wx.Frame):  
    ...
    def toolbarData(self):  
        return (("New", r"C:\Users\jerryfive\Desktop\hsq\new.png.bmp", "Create new sketch", self.OnNew),  
                ("", "", "", ""),  
                ("Open", r"C:\Users\jerryfive\Desktop\hsq\open.png.bmp", "Open existing sketch", self.OnOpen),  
                ("Save", r"C:\Users\jerryfive\Desktop\hsq\save.png", "Save existing sketch", self.OnSave))  
...
class SketchApp(wx.App):  
    def OnInit(self):  
        bmp = wx.Image(r"C:\Users\jerryfive\Desktop\hsq\splash.png").ConvertToBitmap()  
