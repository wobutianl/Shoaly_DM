...
class DataInsertPanel( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        #pg.Append( wxpg.StringProperty(u"数据库名",name = "db_name" ,value="localhost") )
        #pg.Append( wxpg.StringProperty(u"集合名",name = "collect_name" ,value="localhost"))
    ...
    def OnSureBtn(self , event):
        ...
        if ((os.path.splitext(filePath)[1]  == ".shp") or (os.path.splitext(filePath)[1]  == ".SHP")): 
            shp2mongo = shp2mongoDB.shp2mongodb(filePath)
            shp2mongo.insert(databaseName, collectName , "metaDB", collectName)              
        #上传 excel 文件
