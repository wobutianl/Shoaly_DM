...
class MyFrame(wx.Frame):
    def __init__(self, parent, log):
	wx.Frame.__init__(self, parent, -1, "pop grid", size=(700,400))
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.grid, 1, wx.EXPAND, 0)
        sizer_2.Add(sizer_3, 0, wx.EXPAND, 0)
        sizer_4.Add(self.panel, 1, wx.EXPAND, 0)
